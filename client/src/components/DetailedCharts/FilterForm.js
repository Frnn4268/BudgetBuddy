...
const FilterForm = ({ filters, handleChange, handleSubmit }) => {
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" className="bg-yellow-500 text-white py-2 px-4 rounded-md hover:bg-yellow-600 transition duration-300 w-full flex items-center justify-center space-x-2">
